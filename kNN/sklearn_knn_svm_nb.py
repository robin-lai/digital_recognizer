...
def loadTrainData():
    l=[]
    with open('F:\\kaggle\\digit-recognizer\\train.csv') as file:
...
def loadTestData():
    l=[]
    with open('F:\\kaggle\\digit-recognizer\\test.csv') as file:
         lines=csv.reader(file)
         for line in lines:
...
def loadTestResult():
    l=[]
    with open('F:\\kaggle\\digit-recognizer\\knn_benchmark.csv') as file:
         lines=csv.reader(file)
         for line in lines:
...
def knnClassify(trainData,trainLabel,testData):
    ...
    saveResult(testLabel,'F:\\kaggle\\digit-recognizer\\sklearn_knn_Result.csv')
    return testLabel
...
def svcClassify(trainData,trainLabel,testData):
    ...
    saveResult(testLabel,'F:\\kaggle\\digit-recognizer\\sklearn_SVC_C=5.0_Result.csv')
    return testLabel
...
def GaussianNBClassify(trainData,trainLabel,testData):
    ...
    saveResult(testLabel,'F:\\kaggle\\digit-recognizer\\sklearn_GaussianNB_Result.csv')
    return testLabel
...
def MultinomialNBClassify(trainData,trainLabel,testData):
    ...
    nbClf.fit(trainData,ravel(trainLabel))
    testLabel=nbClf.predict(testData)
    saveResult(testLabel,'F:\\kaggle\\digit-recognizer\\sklearn_MultinomialNB_alpha=0.1_Result.csv')
    return testLabel
...
print "debuger out the fun"
print "stop in breakpoint"
for i in range(4):
    print i
